...
const stats = [
  { icon: CalendarDays, label: "Event Date", value: "18 Sep 2026" },
  { icon: Users, label: "Events", value: "7+" },
  { icon: Award, label: "Fee", value: "₹250" },
    ...
    <div className="page-shell">
      ...
      <section className="about-feature">
        <div className="about-device" aria-hidden="true">
          <Sparkles size={48} />
          <span className="about-device-date">18 · 09 · 2026</span>
        </div>
        <div className="about-body">
          <span className="eyebrow">The Symposium</span>
          <h2>Join us on September 18, 2026</h2>
          <p>
